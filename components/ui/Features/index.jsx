    ...
    const features = [
        {
            ...
            desc: "Premium fabrics for unmatched comfort and durability. We source the softest lace, smoothest silks, and finest mesh to ensure each piece feels like a second skin."
        },
        {
            icon:
            ...
            title: "Perfect Fit",
            desc: "Inclusive sizing to celebrate all body types, sizes and styles tailored to embrace all shapes and curves, we aim to make every woman feel celebrated."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            desc: "Stunning designs to suit every mood and occasion. Every detail, from intricate embroidery to thoughtfully placed straps, is designed to captivate and inspire."
        }
    ]
